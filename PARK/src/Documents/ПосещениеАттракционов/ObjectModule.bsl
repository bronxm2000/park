...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Запрос.Текст = 
		...
		|ИЗ
		|	РегистрНакопления.АктивныеПосещения.Остатки(&ДатаДок, Основание = &Основание) КАК АктивныеПосещенияОстатки
		|ГДЕ
	...
	Если Не Запрос.Выполнить().Пустой() Тогда
		...
		Сообщение.Текст="По одному билету можно прохохить только 1 раз!";
